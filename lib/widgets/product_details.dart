            ...
            child: Stack(
              children: [
                Positioned(
                  ...
                  right: 0,
                  child:  Image.network(
                            product.aData?.photos![0].thumbs!.the7681024 ?? '', fit: BoxFit.fitHeight,),

                ),
                const Positioned(
                  top: 36,
                  left: 0,
                  child: CartButtonWhite()),
                Positioned(
                  top: 36,
                  right: 16,
                  child: Container(
          ...
          Column(
            children: [
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => AddedToCartScreen(product: product),
                      ),
                    );
                  },
              ...
              Padding(
                padding: const EdgeInsets.all(16.0),
                child: Text(
                  product.aData?.descriptions?.text ?? 'No description available',
